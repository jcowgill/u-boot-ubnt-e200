...
#define EBH5600_DEF_DRAM_FREQ  200
...
/*
** The EBH5600 does not use the internal arbiter in Octeon.
...
/* Enable Octeon built-in networking if RGMII or SGMII support is enabled */
