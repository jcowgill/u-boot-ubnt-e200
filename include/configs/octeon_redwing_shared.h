#ifndef __OCTEON_NIC10E_SHARED_H__
#define __OCTEON_NIC10E_SHARED_H__



#define OCTEON_NIC10E_DRAM_SOCKET_CONFIGURATION0 \
    {{0x50, 0x0}, {NULL, NULL}}



#define OCTEON_NIC10E_BOARD_EEPROM_TWSI_ADDR        (0x53)
...
#define OCTEON_NIC10E_MODEREG_PARAMS1_1RANK_1SLOT       \
    { .cn63xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_NIC10E_MODEREG_PARAMS1_1RANK_2SLOT       \
    { .cn63xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
...
#define OCTEON_NIC10E_MODEREG_PARAMS1_2RANK_1SLOT       \
    { .cn63xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_NIC10E_MODEREG_PARAMS1_2RANK_2SLOT       \
    { .cn63xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_NIC10E_CN63XX_DRAM_ODT_1RANK_CONFIGURATION \
    /* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ========================================== ========= ============== ======== */ \
    /*   1 */ {   0,    0x00000001ULL, OCTEON_NIC10E_MODEREG_PARAMS1_1RANK_1SLOT,    3,     0x00000000ULL,  0  },      \
    /*   2 */ {   0,    0x00050005ULL, OCTEON_NIC10E_MODEREG_PARAMS1_1RANK_2SLOT,    3,     0x00010004ULL,  0  }

#define OCTEON_NIC10E_CN63XX_DRAM_ODT_2RANK_CONFIGURATION \
    /* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ========================================== ========= ============== ======== */ \
    /*   1 */ {   0,    0x00000101ULL, OCTEON_NIC10E_MODEREG_PARAMS1_2RANK_1SLOT,    3,     0x00000000ULL,    0  },    \
    /*   2 */ {   0,    0x06060909ULL, OCTEON_NIC10E_MODEREG_PARAMS1_2RANK_2SLOT,    3,     0x02020808ULL,    0  }
...
#define OCTEON_NIC10E_DDR_CONFIGURATION                         \
    /* Interface 0 */                                           \
    {                                                           \
        .custom_lmc_config = {                                  \
            .min_rtt_nom_idx	= 1,                            \
            ...
            .parity		= 0},                           \
            .dimm_config_table = {                              \
            OCTEON_NIC10E_DRAM_SOCKET_CONFIGURATION0,           \
...
#endif   /* __OCTEON_NIC10E_SHARED_H__ */
