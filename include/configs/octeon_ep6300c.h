...
#define OCTEON_SGMII_ENET	/* Board has SGMII interface */
#define OCTEON_XAUI_ENET	/* Board has XAUI interface */
#define OCTEON_MGMT_ENET	/* Board has management enet interface */
