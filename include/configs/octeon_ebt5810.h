...
/*
 * The EBT5810 does not use the internal arbiter in Octeon.
...
#define CONFIG_I2C_EEPROM_ADDR     		BOARD_EEPROM_TWSI_ADDR
#endif
...
/* DTT sensor
 * The ebt5810 board has a TI TMP421 temperature sensor.
 *
 * - range -55C to +127C
