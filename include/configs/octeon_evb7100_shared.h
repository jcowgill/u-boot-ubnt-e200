#ifndef __OCTEON_EVB7100_SHARED_H__
#define __OCTEON_EVB7100_SHARED_H__
...
#define OCTEON_EVB7100_DRAM_SOCKET_CONFIGURATION0 \
    {{0x00, 0x00}, {EVB7100_spd_values, NULL}},{{0x00, 0x0}, {NULL, NULL}}
#else
#define OCTEON_EVB7100_DRAM_SOCKET_CONFIGURATION0 \
...
#define OCTEON_EVB7100_BOARD_EEPROM_TWSI_ADDR        (0x56)
...
#define OCTEON_EVB7100_MODEREG_PARAMS1_1RANK_1SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_EVB7100_MODEREG_PARAMS1_1RANK_2SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
...
#define OCTEON_EVB7100_MODEREG_PARAMS1_2RANK_1SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
 ...
 /* Some 2-rank dimms work better in the EVB7100 board using 20 ohms
    for rtt_nom_01/11 at 1333 DDR */
#define OCTEON_EVB7100_MODEREG_PARAMS1_2RANK_2SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = 0,                    \
...
#define OCTEON_EVB7100_MODEREG_PARAMS1_4RANK_1SLOT      \
    { .cn61xx = { .pasr_00      = 0,                    \
                  .asr_00       = 0,                    \
                  .srt_00       = 0,                    \
                  .rtt_wr_00    = rttwr_120ohm,         \
...
#define OCTEON_EVB7100_DDR_CONFIGURATION                                \
    /* Interface 0 */                                                   \
    {                                                                   \
        .custom_lmc_config = {                                          \
            .min_rtt_nom_idx	= 2,                                    \
            ...
            .mode32b		= 0},                                   \
            .dimm_config_table = {                                      \
            OCTEON_EVB7100_DRAM_SOCKET_CONFIGURATION0,                  \
            ...
            .lmc_delay_dq = 0},                                         \
                           .odt_1rank_config = {                        \
            OCTEON_EVB7100_CN61XX_DRAM_ODT_1RANK_CONFIGURATION},        \
                                .odt_2rank_config = {                   \
            OCTEON_EVB7100_CN61XX_DRAM_ODT_2RANK_CONFIGURATION},        \
                                     .odt_4rank_config = {              \
            OCTEON_EVB7100_CN61XX_DRAM_ODT_4RANK_CONFIGURATION}         \
    }

#endif   /* __OCTEON_EVB7100_SHARED_H__ */
