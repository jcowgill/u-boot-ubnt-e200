...
#define CONFIG_OCTEON_AUTHENTIK_STAGE1_ADDR		0xFFFFFFFF81000000ull
#define CONFIG_OCTEON_AUTHENTIK_STAGE1_SIZE		(256 * 1024)

#define CONFIG_OCTEON_AUTHENTIK_STAGE2_CACHE_ADDR	0xFFFFFFFF82000000ull
#define CONFIG_OCTEON_AUTHENTIK_STAGE2_CACHE_SIZE	(2 * 1024 * 1024)
#endif

#include "octeon_common.h"

/* CONFIG_OCTEON_EBB6600 set by Makefile in include/config.h */

/* Default DDR clock if tuple doesn't exist in EEPROM */
#define EBB6600_DEF_DRAM_FREQ		533
...
#define CONFIG_SYS_I2C_EEPROM_ADDR	OCTEON_EBB6600_BOARD_EEPROM_TWSI_ADDR
...
/*
 * The EBB6600 does not use the internal arbiter in Octeon.
...
/* Add NAND support */
/* NOTE: The default NAND part on the EBB6600 is not suitable for UBIFS
 * or NAND booting support due to inadequate ECC support by both the OCTEON
 * hardware and U-Boot and Linux's drivers.
 */
/** Disable UBI and UBIFS support */
...
/* Display information about the boot bus */
...
/* DTT sensor
 * The ebb6600 board has a TI TMP421 temperature sensor.  This part is basically
...
#include "octeon_ebb6600_shared.h"
...
#define OCTEON_EBB6600_CN66XX_DFM_ODT_CONFIGURATION \
    /* RANKS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */ \
    /* =====   ======== ============== ========================================== ========= ============== ======== */ \
    /*   1 */ {   0,    0x00000001ULL, OCTEON_EBB6600_MODEREG_PARAMS1_1RANK_1SLOT,    5,     0x00000000ULL,  0  },     \
    /*   2 */ {   0,    0x00000101ULL, OCTEON_EBB6600_MODEREG_PARAMS1_2RANK_1SLOT,    5,     0x00000000ULL,  0  }

#define OCTEON_CN63XX_DFM_ODT_CONFIGURATION OCTEON_EBB6600_CN66XX_DFM_ODT_CONFIGURATION
