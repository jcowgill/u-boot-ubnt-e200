...
typedef enum {
	ENV_NORMAL,		/* Continue processing like normal setenv */
	ENV_NO_REPLACE,		/* Do not replace the existing value */
	ENV_ERROR		/* Error */
} env_set_hook_rc_t;
...
/* Architecture hook called whenever an environment variable is set */
env_set_hook_rc_t setenv_arch(const char *var, const char *old_value,
			      const char *new_value);

/* Board hook called whenever an environment variable is set */
