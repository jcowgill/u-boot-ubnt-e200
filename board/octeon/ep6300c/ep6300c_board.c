...
int early_board_init(void)
{
	...
	/* Even though the CPU ref freq is stored in the clock descriptor,
	 * we don't read it here.  The MCU reads it and configures the clock,
	 * and we read how the clock is actually configured.
