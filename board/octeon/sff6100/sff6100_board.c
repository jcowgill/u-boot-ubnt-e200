...
int early_board_init(void)
{
	...
	/* Configure the QLMs */
	cvmx_qlm_configure_qlm(2, 1250, 2, 0, 0);

	if (gpio_get_value(12))
		cvmx_qlm_configure_qlm(0, 1250, 2, 0, 0);
	else
		cvmx_qlm_configure_qlm(0, 5000, 0, 1, 3);

	if (gpio_get_value(14))
		cvmx_qlm_configure_qlm(1, 5000, 0, 1, 0);
	else
		cvmx_qlm_configure_qlm(1, 5000, 1, 1, 3);
