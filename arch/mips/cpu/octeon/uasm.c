 ...
 * 
 * This file was imported from the Linux version.
 */
#undef DEBUG
#include <common.h>
...
#ifdef CONFIG_64BIT
	return (((addr) & 0xffffffff00000000ull) == 0xffffffff00000000ull);
#else
	return 1;
#endif
}
...
{
#ifdef CONFIG_64BIT
	return ((((val + 0x800080008000ull) >> 48) & 0xffff) ^ 0x8000) - 0x8000;
#else
	return 0;
#endif
}
...
{
#ifdef CONFIG_64BIT
	return ((((val + 0x80008000ull) >> 32) & 0xffff) ^ 0x8000) - 0x8000;
#else
	return 0;
#endif
}
