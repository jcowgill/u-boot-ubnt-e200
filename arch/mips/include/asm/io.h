...
#if 0
/*
 * IO bus memory addresses are not 1:1 with the physical address
 */
static inline phys_addr_t virt_to_bus(void * address)
{
	return cvmx_ptr_to_phys(address);
}
#endif
#if 0
static inline void * bus_to_virt(phys_addr_t address)
{
	return (void *)cvmx_phys_to_ptr(address);
}
#endif
#if 0
/*
...
{
	return (void *)((uint32_t)CKSEG0ADDR(address));
}
