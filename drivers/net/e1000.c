...
fill_rx(struct e1000_hw *hw)
{
	...
	memset(rd, 0, 16);
#ifdef CONFIG_OCTEON
	rd->buffer_addr = cpu_to_le64(virt_to_bus(hw->pdev, &packet));
#else
...
#ifdef CONFIG_OCTEON
	dma_addr_t tx_base_addr = virt_to_bus(hw->pdev, (void *)ptr);

	E1000_WRITE_REG(hw, TDBAL, (u32)(tx_base_addr & 0xFFFFFFFF));
	E1000_WRITE_REG(hw, TDBAH, (u32)(tx_base_addr >> 16) >> 16);
#else
...
#ifdef CONFIG_OCTEON
	dma_addr_t rx_base_addr = virt_to_bus(hw->pdev, rx_base);
	E1000_WRITE_REG(hw, RDBAL, (u32)rx_base_addr & 0xFFFFFFFF);
	E1000_WRITE_REG(hw, RDBAH, (rx_base_addr >> 16) >> 16);
#else
